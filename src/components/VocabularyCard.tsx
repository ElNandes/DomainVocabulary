...
const VocabularyCard: React.FC<VocabularyCardProps> = ({ term, onUpdate }) => {
  ...
  return (
    <div className="flex justify-center py-4">
      <div
        className={`aspect-[9/16] w-full max-w-[340px] bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden flex flex-col transition-all duration-300 ${term.learned ? 'bg-green-50' : 'bg-white'}`}
      >
        {/* Card header */}
        <div 
